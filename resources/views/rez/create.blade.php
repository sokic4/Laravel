...
@section('content')
    ...
    <div class="form-group">
        ...
        <!--  oclass opet bootstrap-->
        {{Form::text('polazna_destinacija','', ['class'=>'form-control','placeholder'=>'polazna_destinacija'])}}
    </div>
    <div class="form-group">
        {{Form::label('krajnja','Krajnja destinacija')}}
        <!--  oclass opet bootstrap-->
        {{Form::text('krajnja_destinacija','', ['class'=>'form-control','placeholder'=>'krajnja_destinacija'])}}
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <!--  oclass opet bootstrap-->
        {{ Form::date('datum_vracanja','', ['class'=>'form-control','placeholder'=>'datum_vracanja'])}}
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <!--  oclass opet bootstrap-->
        {{Form::textarea('model','', ['class'=>'form-control','placeholder'=>'model'])}}
    </div>
    <div class="form-group">
        {{Form::label('automobil_id','Automobil id')}}
        <!--  oclass opet bootstrap-->
        {{Form::text('automobil_id','', ['class'=>'form-control','placeholder'=>'automobil_id'])}}
    </div>
    <div class="form-group">
